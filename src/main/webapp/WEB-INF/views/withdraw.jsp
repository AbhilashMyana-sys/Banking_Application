...
<head>
    ...
    <style>
        body {/* Removed invalid property value for background-attachment */
font-family: 'Arial', sans-serif;
justify-content: center;
align-items: center;
height: 100vh;
background-color: #ffffff; /* white background */
background-image: url(atm-atm.jpeg); /* Correct file path */
background-position: center;
background-size: 10%; /* Specify size, e.g., 10%, cover, contain, etc. */
