...
<head>
  ...
  <style>
    body {
            ...
            width: 100%;
            height: 150%;
            background-image: url(role-selection-img.jpeg);
...
.header-strip {
  background-color: #ffffff; /* Adjust the alpha value (last parameter) as needed */
  padding: 10px 0;
  text-align: center;
  color: black ;
}
   ...
   .welcome-message{
    ...
    p {
        text-align: center;
        color: #092635;
        animation: no blink  infinite alternate; /* Add blinking animation */
    }
    @keyframes blink {
        0% {
            opacity: 1;
